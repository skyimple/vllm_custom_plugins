...
void launch_paged_attention_v1(at::Tensor& q, at::Tensor& k_buffer, at::Tensor& v_buffer, at::Tensor& block_table, at::Tensor& context_lens, at::Tensor& out, int block_size);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // real paged_attention
    m.def("paged_attention_v1", &launch_paged_attention_v1, "Production PagedAttention Full Kernel v1");
}